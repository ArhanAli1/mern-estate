...
const navigate=useNavigate();
  ...
  const handleSubmit=async(e)=>{
      ...
      try {
        ...
        setError('Discount price must be lower then regular price')
        setLoading(true);
        setError(false);
    ...
    <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
      <div className=" flex flex-col gap-4 flex-1">
        ...
        <div className="flex flex-wrap gap-6">
          ...
          <div className="flex items-center gap-2">
            <input type="number" id='regularPrice' min='50000' max='100000' required 
            className='p-3 border border-gray-300 rounded-lg'
      ...
      <div className="flex flex-col flex-1 gap-4">
        ...
        <input onChange={(e)=> setFiles(e.target.files)} className='p-3 border border-gray-300 rounded w-full' type="file" id='images' 
      ...
      disabled:opacity-80'> {loading ? 'Creating...':'Create listing'} </button>
